...
import { View, Text, TextInput, TouchableOpacity, Picker, Button, ScrollView } from 'react-native'
            ...
            <ScrollView>
                ...
                <View style={{flexDirection: 'row', justifyContent:'center', alignItems: 'center'}}>
                    <Picker style={styles.pickerStyle}>
                        ...
                        <View style={{backgroundColor: 'white', width: 25, height: 25, borderRadius: 20, justifyContent: 'center', position:'absolute', right: 30}}>
                            <Icon name='ios-arrow-down' size={22} color='black' style={{alignSelf: 'center'}} />
                        </View>
                </View>
                ...
                <View style={styles.containerItem}>
                    <TextInput 
                        placeholder={`Rp.`} 
                        style={{marginHorizontal: 12, borderWidth: 0.5, borderColor: 'grey', height: 35, padding: 5}} />
                </View>
                ...
                <View style={styles.containerItem}>
                    <TextInput 
                        placeholder={`%`} 
                        style={{marginHorizontal: 12, borderWidth: 0.5, borderColor: 'grey', height: 35, padding: 5, textAlign:'right'}} />
                </View>
